...
import sec_agent_sdk.models
from dateutil.parser import parse
from pydantic import SecretStr
from sec_agent_sdk import rest
from sec_agent_sdk.api_response import ApiResponse
from sec_agent_sdk.api_response import T as ApiResponseT
from sec_agent_sdk.configuration import Configuration
from sec_agent_sdk.exceptions import (
    ApiException,
    ApiValueError,
)
...
class ApiClient:
    ...
    def param_serialize(
        ...
        if header_params:
            ...
            header_params["x-api-key"] = config.api_key["APIKeyHeader"]
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sec_agent_sdk.models, klass)
