...
class DefaultApi:
    ...
    def search_sec_filing_v2_get(
        ...
        _param = self._search_sec_filing_v2_get_serialize(
            form_type=form_type,
            company=company,
            table=table,
            date_filed=date_filed,
    ...
    @validate_call
    def search_sec_filing_v2_get_with_http_info(
        self,
        form_type: FormType,
        company: StrictStr,
        table: FilingTable,
    ...
    @validate_call
    def search_sec_filing_v2_get_without_preload_content(
        self,
        form_type: FormType,
        company: StrictStr,
        table: FilingTable,
    ...
    def _search_sec_filing_v2_get_serialize(
        self,
        form_type,
        company,
        table,
